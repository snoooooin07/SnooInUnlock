...
echo.
echo   *SNOO_IN_UNLOCK SERVICE !local_version!*
echo   -----------------------------------------------------------------------------------------------------------
echo.                                                                                              
echo     -1. Install Service (on all PC)           3. Check status-                                                                                                                  
echo     -2. Remove Services (on all PC)           4. Game filter  [!GameFilterStatus!]-                              
echo     -5. IPset filter [!IPsetStatus!]                    6. Update IPSet file-                                      
echo     -7. Update hosts file* (for Telegram Web) 8. Check for updates-                                           
echo     -9. Run Diagnostics                       10. Run Tests-
echo.     Some files may be copied from "zapret". These files are required for the program to function correctly.
echo   ------------------------------------------------------------------------------------------------------------
echo      *0. Close Service*                                                                     RL Corp. 2024-2026
echo.                                                
...
if "%menu_choice%"=="8" goto service_check_updates
